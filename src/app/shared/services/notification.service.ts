...
export class NotificationService {
   ...
   * @returns {any}
   */
  public showSuccess(message: string, title?: any, progressBar?: boolean, timeOut = this.DEFAULT_DELAY, positionClass = NotificationPosition.TOP_RIGHT): any {
  ...
  public showError(message: string, error?,  title?: any, timeOut = this.DEFAULT_DELAY, positionClass = NotificationPosition.TOP_RIGHT): any {
    return this.toastr.error(message, title, {timeOut: timeOut === null ? this.DEFAULT_DELAY : timeOut, positionClass});
  }
